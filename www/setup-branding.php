    ...
    <body>
        <div id="login">
            <div id="custid-section">
                ...
                <input type="text" id="custid" placeholder="CustID" <?php if (isset($_GET['organization'])) { echo 'value="'.$_GET['organization'].'" '; } ?>/><br /><br />
                <button onclick="oaloadbranding();">Load Existing Branding</button><br />
            </div>
